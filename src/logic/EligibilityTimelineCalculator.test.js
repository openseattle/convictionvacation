...
let singleConvictionTestData = [
    ...
    ["Gross Misdemeanor 3 Years has passed since relevant date", CrimeClassification["GROSS MISDEMEANOR"], false, false, "2014-01-01", "2019-01-01", "1990-01-01", true],
    ["Gross Misdemeanor with Domestic Violence, 5 Years has passed since relevant date", CrimeClassification["GROSS MISDEMEANOR"], true, false, "2014-01-01", "2019-01-01", "1990-01-01", true],
    ["Gross Misdemeanor with DUI, 10 Years has passed since relevant date", CrimeClassification["GROSS MISDEMEANOR"], false, true, "2009-01-01", "2019-01-01", "1990-01-01", true],
    ["Gross Misdemeanor with Domestic Violence & DUI, 10 Years has passed since relevant date", CrimeClassification["GROSS MISDEMEANOR"], false, true, "2009-01-01", "2019-01-01", "1990-01-01", true],
    ...
    ["Gross Misdemeanor 3 Years has not passed since relevant date", CrimeClassification["GROSS MISDEMEANOR"], false, false, "2016-07-01", "2019-01-01", "1990-01-01", false],
    ["Gross Misdemeanor with Domestic Violence, 5 Years has not passed since relevant date", CrimeClassification["GROSS MISDEMEANOR"], true, false, "2014-03-01", "2019-01-01", "1990-01-01", false],
    ["Gross Misdemeanor with DUI, 10 Years has not passed since relevant date", CrimeClassification["GROSS MISDEMEANOR"], false, true, "2009-07-01", "2019-01-01", "1990-01-01", false],
    ["Gross Misdemeanor with Domestic Violence & DUI, 10 Years has not passed since relevant date", CrimeClassification["GROSS MISDEMEANOR"], false, true, "2009-07-01", "2019-01-01", "1990-01-01", false],
