...
let singleConvictionTestData = [
    ...
    ["Misdemeanor 3 Years has not passed since relevant date", CrimeClassification.MISDEMEANOR, false, false, "2016-01-15", "2019-01-01", false],
    ["Misdemeanor with Domestic Violence, 5 Years has not passed since relevant date", CrimeClassification.MISDEMEANOR, true, false, "2014-03-01", "2019-01-01", false],
    ["Misdemeanor with DUI, 10 Years has not passed since relevant date", CrimeClassification.MISDEMEANOR, false, true, "2009-02-01", "2019-01-01", false],
    ["Misdemeanor with Domestic Violence & DUI, 10 Years has not passed since relevant date", CrimeClassification.MISDEMEANOR, true, true, "2009-02-01", "2019-01-01", false],
    ["Gross Misdemeanor 3 Years has not passed since relevant date", CrimeClassification["GROSS MISDEMEANOR"], false, false, "2016-07-01", "2019-01-01", false],
    ["Gross Misdemeanor with Domestic Violence, 5 Years has not passed since relevant date", CrimeClassification["GROSS MISDEMEANOR"], true, false, "2014-03-01", "2019-01-01", false],
    ["Gross Misdemeanor with DUI, 10 Years has not passed since relevant date", CrimeClassification["GROSS MISDEMEANOR"], false, true, "2009-07-01", "2019-01-01", false],
    ["Gross Misdemeanor with Domestic Violence & DUI, 10 Years has not passed since relevant date", CrimeClassification["GROSS MISDEMEANOR"], false, true, "2009-07-01", "2019-01-01", false],
    ["Felony B 10 Years has not passed since relevant date", CrimeClassification.FELONY_CLASS_B, false, false, "2010-01-01", "2019-01-01", false],
    ["Felony C 5 Years has not passed since relevant date", CrimeClassification.FELONY_CLASS_C, false, false, "2015-12-01", "2019-01-01", false],
...
//   Calculation Date, Expected Conviction Vacatable
...
test.each(multipleConvictionsTestData)(
    'Multiple convictions=%s, calculationDate="%s"',
    (convictions, calculationDate, expectedVacatable) => {
        let calculator = new ConvictionCalculator();
        let convictionInputs = convictions.map((conviction, index) => {
            return new ConvictionInput(TEST_ID + index, ...conviction);
        });
        let input = new CalculatorInput(calculationDate, convictionInputs);
        let actualCalculatorOutput = calculator.calculate(input);
